...
#define sagTemelHiz 200 // Sensor tam cizginin uzerindeyken izlemesi gereken hiz
#define solTemelHiz 200 //  Sensor tam cizginin uzerindeyken izlemesi gereken hiz
#define SENSOR_SAYISI 8
...
QTRSensorsAnalog qtrrc((unsigned char[]){0, 1, 2, 3, 4, 5, 6, 7},
